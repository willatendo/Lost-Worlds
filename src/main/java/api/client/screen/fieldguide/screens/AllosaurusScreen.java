package api.client.screen.fieldguide.screens;

import com.mojang.blaze3d.matrix.MatrixStack;
import com.mojang.blaze3d.systems.RenderSystem;

import api.client.screen.fieldguide.FieldGuideLang;
...
@OnlyIn(Dist.CLIENT)
public class AllosaurusScreen extends Screen
{
	...
	public AllosaurusScreen() 
	{
		super(ModUtil.tTC("fieldGuide", "allosaurus_name"));
	...
	public void render(MatrixStack stack, int mouseX, int mouseY, float partialTicks) 
	{
		...
		this.font.draw(stack, ModUtil.tTC("fieldGuide", "allosaurus_danger"), 65, 116, FONT_COLOUR);
		this.font.draw(stack, ModUtil.tTC("fieldGuide", "allosaurus_diet"), 65, 126, FONT_COLOUR);
		this.font.draw(stack, ModUtil.tTC("fieldGuide", "allosaurus_time_era"), 65, 136, FONT_COLOUR);
		this.font.draw(stack, ModUtil.tTC("fieldGuide", "allosaurus_type"), 65, 146, FONT_COLOUR);
