...
import api.client.entity.model.GreatAukModel;
...
@OnlyIn(Dist.CLIENT)
public class GreatAukRender extends GeoEntityRenderer<GreatAukEntity>
{
	public GreatAukRender(EntityRendererManager renderManager) 
	{
