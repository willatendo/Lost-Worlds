...
import api.client.entity.model.TyrannosaurusModel;
...
@OnlyIn(Dist.CLIENT)
public class TyrannosaurusRender extends GeoEntityRenderer<TyrannosaurusEntity>
{
	public TyrannosaurusRender(EntityRendererManager renderManager) 
	{
