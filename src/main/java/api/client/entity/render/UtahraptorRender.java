...
import api.client.entity.model.UtahraptorModel;
...
@OnlyIn(Dist.CLIENT)
public class UtahraptorRender extends GeoEntityRenderer<UtahraptorEntity>
{
	public UtahraptorRender(EntityRendererManager renderManager) 
	{
