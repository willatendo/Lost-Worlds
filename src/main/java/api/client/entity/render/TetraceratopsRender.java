...
import api.client.entity.model.TetraceratopsModel;
...
@OnlyIn(Dist.CLIENT)
public class TetraceratopsRender extends GeoEntityRenderer<TetraceratopsEntity>
{
	public TetraceratopsRender(EntityRendererManager renderManager) 
	{
