package lostworlds.common.goal.controller;
...
public class AnimalSwimMoveController extends MovementController 
{
    private final CreatureEntity entity;
    private float speedMulti;
    private float ySpeedMod = 1;

    public AnimalSwimMoveController(CreatureEntity entity, float speedMulti, float ySpeedMod) 
    {
        super(entity);
        this.entity = entity;
    ...
    public void tick() 
    {
        if(this.operation == Action.MOVE_TO && !this.entity.getNavigation().isDone()) 
        {
            ...
            else 
            {
                ...
                this.entity.yRot = this.rotlerp(this.entity.yRot, lvt_9_1_, 10.0F);
