...
public class ProcompsognathusEggBlock extends AbstractDinosaurEgg
{
	@Override
	...
	public void randomTick(BlockState state, ServerWorld world, BlockPos pos, Random rand) 
	{
		if(this.shouldUpdateHatchLevel(world) && onNest(world, pos)) 
		{
			...
			else 
			{
				...
				ProcompsognathusEntity procompsognathus = EntityInit.PROCOMPSOGNATHUS_ENTITY.get().create(world);
				procompsognathus.moveTo((double)pos.getX() + 0.3D * 0.2D, (double)pos.getY(), (double)pos.getZ() + 0.3D, 0.0F, 0.0F);
				world.addFreshEntity(procompsognathus);
				procompsognathus.setAge(-24000);
			}
		}
	}
}
