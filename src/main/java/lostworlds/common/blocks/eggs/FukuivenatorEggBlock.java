...
public class FukuivenatorEggBlock extends AbstractDinosaurEgg
{
	@Override
	...
	public void randomTick(BlockState state, ServerWorld world, BlockPos pos, Random rand) 
	{
		if(this.shouldUpdateHatchLevel(world) && onNest(world, pos)) 
		{
			...
			else 
			{
				...
				FukuivenatorEntity fukuivenator = EntityInit.FUKUIVENATOR_ENTITY.get().create(world);
				fukuivenator.moveTo((double)pos.getX() + 0.3D * 0.2D, (double)pos.getY(), (double)pos.getZ() + 0.3D, 0.0F, 0.0F);
				world.addFreshEntity(fukuivenator);
				fukuivenator.setAge(-24000);
			}
		}
	}
}
