...
public class RecipeSerialiserInit
{
	...
	public static final RegistryObject<IRecipeSerializer<?>> EXAMPLE_SERIALIZER = ModRegistry.RECIPE_SERIALISER_REGISTRY.register("fossil_cleaner", () -> FOSSIL_CLEANER_RECIPE_SERIALIZER);
