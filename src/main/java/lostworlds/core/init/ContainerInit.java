...
import lostworlds.common.container.AnalyerContainer;
...
public class ContainerInit 
{
	...
	public static final RegistryObject<ContainerType<AnalyerContainer>> ANALYSER_CONTAINER = ModRegistry.CONTAINER_REGISTRY.register("analyser_container", () -> IForgeContainerType.create(AnalyerContainer::new));
