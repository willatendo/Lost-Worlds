...
public class ItemInit 
{
	...
	public static final RegistryObject<BlockItem> DIRT_FOSSIL = ModRegistry.ITEM_REGISTRY.register("dirt_fossil", () -> new BlockItem(BlockInit.DIRT_FOSSIL.get(), standardProperties()));
