...
public class BlockInit 
{
	...
	//Fossils
	public static final RegistryObject<StoneFossilBlock> STONE_FOSSIL = ModRegistry.BLOCK_REGISTRY.register("stone_fossil", () -> new StoneFossilBlock(AbstractBlock.Properties.of(ModMaterials.MADE_FOR_BRUSH, MaterialColor.STONE).harvestTool(ModToolTypes.BRUSH).harvestLevel(0).requiresCorrectToolForDrops().strength(1.5F).sound(SoundType.STONE)));
	...
	public static final RegistryObject<TerracottaFossilBlock> TERRACOTTA_FOSSIL = ModRegistry.BLOCK_REGISTRY.register("terracotta_fossil", () -> new TerracottaFossilBlock(AbstractBlock.Properties.of(ModMaterials.MADE_FOR_BRUSH, MaterialColor.COLOR_ORANGE).harvestTool(ModToolTypes.BRUSH).harvestLevel(0).requiresCorrectToolForDrops().strength(1.5F).sound(SoundType.STONE)));
	...
	public static final RegistryObject<RedTerracottaFossilBlock> RED_TERRACOTTA_FOSSIL = ModRegistry.BLOCK_REGISTRY.register("red_terracotta_fossil", () -> new RedTerracottaFossilBlock(AbstractBlock.Properties.of(ModMaterials.MADE_FOR_BRUSH, MaterialColor.TERRACOTTA_RED).harvestTool(ModToolTypes.BRUSH).harvestLevel(0).requiresCorrectToolForDrops().strength(1.5F).sound(SoundType.STONE)));
	...
	public static final RegistryObject<OrangeTerracottaFossilBlock> ORANGE_TERRACOTTA_FOSSIL = ModRegistry.BLOCK_REGISTRY.register("orange_terracotta_fossil", () -> new OrangeTerracottaFossilBlock(AbstractBlock.Properties.of(ModMaterials.MADE_FOR_BRUSH, MaterialColor.TERRACOTTA_ORANGE).harvestTool(ModToolTypes.BRUSH).harvestLevel(0).requiresCorrectToolForDrops().strength(1.5F).sound(SoundType.STONE)));
	...
	public static final RegistryObject<YellowTerracottaFossilBlock> YELLOW_TERRACOTTA_FOSSIL = ModRegistry.BLOCK_REGISTRY.register("yellow_terracotta_fossil", () -> new YellowTerracottaFossilBlock(AbstractBlock.Properties.of(ModMaterials.MADE_FOR_BRUSH, MaterialColor.TERRACOTTA_YELLOW).harvestTool(ModToolTypes.BRUSH).harvestLevel(0).requiresCorrectToolForDrops().strength(1.5F).sound(SoundType.STONE)));
	...
	public static final RegistryObject<BlueTerracottaFossilBlock> BLUE_TERRACOTTA_FOSSIL = ModRegistry.BLOCK_REGISTRY.register("blue_terracotta_fossil", () -> new BlueTerracottaFossilBlock(AbstractBlock.Properties.of(ModMaterials.MADE_FOR_BRUSH, MaterialColor.TERRACOTTA_BLUE).harvestTool(ModToolTypes.BRUSH).harvestLevel(0).requiresCorrectToolForDrops().strength(1.5F).sound(SoundType.STONE)));
	...
	public static final RegistryObject<BrownTerracottaFossilBlock> BROWN_TERRACOTTA_FOSSIL = ModRegistry.BLOCK_REGISTRY.register("brown_terracotta_fossil", () -> new BrownTerracottaFossilBlock(AbstractBlock.Properties.of(ModMaterials.MADE_FOR_BRUSH, MaterialColor.TERRACOTTA_BROWN).harvestTool(ModToolTypes.BRUSH).harvestLevel(0).requiresCorrectToolForDrops().strength(1.5F).sound(SoundType.STONE)));
	...
	public static final RegistryObject<LightGreyTerracottaFossilBlock> LIGHT_GREY_TERRACOTTA_FOSSIL = ModRegistry.BLOCK_REGISTRY.register("light_grey_terracotta_fossil", () -> new LightGreyTerracottaFossilBlock(AbstractBlock.Properties.of(ModMaterials.MADE_FOR_BRUSH, MaterialColor.TERRACOTTA_LIGHT_GRAY).harvestTool(ModToolTypes.BRUSH).harvestLevel(0).requiresCorrectToolForDrops().strength(1.5F).sound(SoundType.STONE)));
	...
	public static final RegistryObject<Block> FOSSIL_GRINDER = ModRegistry.BLOCK_REGISTRY.register("fossil_grinder", () -> new Block(AbstractBlock.Properties.of(Material.METAL, MaterialColor.COLOR_GRAY).strength(3.0f, 6.0F).requiresCorrectToolForDrops().noOcclusion().sound(SoundType.METAL)));
	public static final RegistryObject<Block> DNA_EXTRACTOR = ModRegistry.BLOCK_REGISTRY.register("dna_extractor", () -> new Block(AbstractBlock.Properties.of(Material.METAL, MaterialColor.COLOR_GRAY).strength(3.0f, 6.0F).requiresCorrectToolForDrops().noOcclusion().sound(SoundType.METAL)));
	public static final RegistryObject<Block> ANALYSER = ModRegistry.BLOCK_REGISTRY.register("analyser", () -> new Block(AbstractBlock.Properties.of(Material.METAL, MaterialColor.COLOR_GRAY).strength(3.0f, 6.0F).requiresCorrectToolForDrops().noOcclusion().sound(SoundType.METAL)));
	public static final RegistryObject<Block> DNA_INSERTER = ModRegistry.BLOCK_REGISTRY.register("dna_inserter", () -> new Block(AbstractBlock.Properties.of(Material.METAL, MaterialColor.COLOR_GRAY).strength(3.0f, 6.0F).requiresCorrectToolForDrops().noOcclusion().sound(SoundType.METAL)));
	...
	//Mossy Dirt
	public static final RegistryObject<MossyDirtBlock> MOSSY_DIRT = ModRegistry.BLOCK_REGISTRY.register("mossy_dirt", () -> new MossyDirtBlock(AbstractBlock.Properties.of(Material.DIRT, MaterialColor.DIRT).strength(0.5F).randomTicks().sound(SoundType.GRAVEL), Blocks.DIRT));
	...
	public static final RegistryObject<ModSaplingBlock> CONIFER_SAPLING = ModRegistry.BLOCK_REGISTRY.register("conifer_sapling", () -> new ModSaplingBlock(new ConiferTree(), AbstractBlock.Properties.of(Material.PLANT).noCollission().randomTicks().instabreak().sound(SoundType.GRASS)));
	...
	public static final RegistryObject<ModStandingSignBlock> CONIFER_SIGN = ModRegistry.BLOCK_REGISTRY.register("conifer_sign", () -> new ModStandingSignBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.SAND).harvestTool(ToolType.AXE).strength(2.5F).sound(SoundType.WOOD).noCollission(), ModWoodTypes.CONIFER));
	...
	public static final RegistryObject<ModSaplingBlock> GINKGO_SAPLING = ModRegistry.BLOCK_REGISTRY.register("ginkgo_sapling", () -> new ModSaplingBlock(new GinkgoTree(), AbstractBlock.Properties.of(Material.PLANT).noCollission().randomTicks().instabreak().sound(SoundType.GRASS)));
	...
	public static final RegistryObject<ModStandingSignBlock> GINKGO_SIGN = ModRegistry.BLOCK_REGISTRY.register("ginkgo_sign", () -> new ModStandingSignBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.SAND).harvestTool(ToolType.AXE).strength(2.5F).sound(SoundType.WOOD).noCollission(), ModWoodTypes.GINKGO));
	...
	public static final RegistryObject<ModSaplingBlock> ARAUCARIA_SAPLING = ModRegistry.BLOCK_REGISTRY.register("araucaria_sapling", () -> new ModSaplingBlock(new AraucariaTree(), AbstractBlock.Properties.of(Material.PLANT).noCollission().randomTicks().instabreak().sound(SoundType.GRASS)));
