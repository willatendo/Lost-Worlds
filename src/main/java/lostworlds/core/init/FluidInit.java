...
public class FluidInit 
{
	...
	//Block
	public static final RegistryObject<FlowingFluidBlock> OIL_BLOCK = ModRegistry.BLOCK_REGISTRY.register("oil_block", () -> new FlowingFluidBlock(() -> FluidInit.OIL_FLUID.get(), AbstractBlock.Properties.create(Material.WATER).doesNotBlockMovement().hardnessAndResistance(100.0F).noDrops()));
