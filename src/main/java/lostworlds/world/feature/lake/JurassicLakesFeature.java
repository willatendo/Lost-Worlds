package lostworlds.world.feature.lake;
...
public class JurassicLakesFeature<T extends BlockStateFeatureConfig> extends Feature<T>
{
	private static final BlockState AIR = Blocks.CAVE_AIR.defaultBlockState();

	public JurassicLakesFeature(Codec<T> config) 
	{
		super(config);
	}
					...
					for(int j3 = 0; j3 < 16; ++j3) 
					{
						for(int j4 = 4; j4 < 8; ++j4) 
						{
							if(aboolean[(i2 * 16 + j3) * 8 + j4]) 
							{
								...
								{
									seedReader.setBlock(blockpos, BlockInit.JURASSIC_STONE.get().defaultBlockState(), 2);
	                           }
							}
						}
					}
					...
					for(int j2 = 0; j2 < 16; ++j2) 
					{
						for(int k3 = 0; k3 < 16; ++k3) 
						{
							for(int k4 = 0; k4 < 8; ++k4) 
							{
								...
								{
									seedReader.setBlock(pos.offset(j2, k4, k3), BlockInit.JURASSIC_STONE.get().defaultBlockState(), 2);
								}
							}
						}
					}
