...
public class ModSurfaceBuilders 
{
	...
	public static final SurfaceBuilderConfig DIRT_TERRAIN_CONFIG = new SurfaceBuilderConfig(Blocks.PODZOL.defaultBlockState(), Blocks.DIRT.defaultBlockState(), Blocks.SAND.defaultBlockState());
