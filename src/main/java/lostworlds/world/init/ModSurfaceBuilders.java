...
public class ModSurfaceBuilders 
{
	...
	public static final SurfaceBuilderConfig DIRT_TERRAIN_CONFIG = new SurfaceBuilderConfig(BlockInit.MOSSY_DIRT.get().defaultBlockState(), Blocks.DIRT.defaultBlockState(), Blocks.SAND.defaultBlockState());
	...
	public static final SurfaceBuilderConfig ISLANDS_CONFIG = new SurfaceBuilderConfig(Blocks.PODZOL.defaultBlockState(), Blocks.DIRT.defaultBlockState(), Blocks.SAND.defaultBlockState());
