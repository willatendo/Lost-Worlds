...
public class ModBlockClusterFeatureConfig 
{
	...
	public static final BlockClusterFeatureConfig DEFAULT_FERNS_CONFIG = (new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(Blocks.FERN.defaultBlockState()), SimpleBlockPlacer.INSTANCE)).tries(32).build();
}
