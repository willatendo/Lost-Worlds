...
public class ModSurfaceBuilders 
{
	...
	public static final SurfaceBuilderConfig OIL_SANDS_SURFACE_BUILDER = new SurfaceBuilderConfig(Blocks.SAND.defaultBlockState(), Blocks.SANDSTONE.defaultBlockState(), Blocks.SAND.defaultBlockState());
