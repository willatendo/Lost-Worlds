...
public class ModSurfaceBuilders 
{
	...
	public static final SurfaceBuilderConfig FLOOD_BASALT_PLAINS = new SurfaceBuilderConfig(Blocks.BASALT.defaultBlockState(), BlockInit.VOLCANIC_ROCK.get().defaultBlockState(), Blocks.BASALT.defaultBlockState());
