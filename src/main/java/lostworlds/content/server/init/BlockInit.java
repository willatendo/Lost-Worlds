...
{	
	...
	public static final Block DEAD_LARGE_PERMIAN_SHRUB = BasicBlockAndItem.create("dead_large_permian_shrub", new ModBushBlock(AbstractBlock.Properties.of(Material.REPLACEABLE_PLANT, MaterialColor.COLOR_GREEN).noCollission().noOcclusion().instabreak().sound(SoundType.GRASS)));
	...
	public static final Block PERMIAN_STONE_BUTTON = BasicBlockAndItem.create("permian_stone_pressure_plate", new StoneButtonBlock(AbstractBlock.Properties.of(Material.STONE, MaterialColor.COLOR_GRAY).requiresCorrectToolForDrops().strength(3.0F)));
