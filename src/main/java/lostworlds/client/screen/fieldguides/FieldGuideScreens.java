...
{	
	...
	public static void utahraptorEntry()
	{
		Minecraft.getInstance().setScreen(new ChilesaurusFieldGuideScreen(FieldGuideLang.UTAHRAPTOR_ENTRY_NAME));
	}
	
	public static void zephyrosaurusEntry()
	{
		Minecraft.getInstance().setScreen(new ChilesaurusFieldGuideScreen(FieldGuideLang.UTAHRAPTOR_ENTRY_NAME));
	}
}
