...
public class NautilusModel extends AnimatedGeoModel<NautilusEntity>
{
	...
	{
		return new ResourceLocation(Reference.ID, "geo/nautilus.geo.json");
	}
	
	@Override
	public ResourceLocation getTextureLocation(NautilusEntity object) 
	{
		return new ResourceLocation(Reference.ID, "textures/model/entity/nautilus.png");
	}
	
	@Override
	public ResourceLocation getAnimationFileLocation(NautilusEntity animatable) 
	{
		return new ResourceLocation(Reference.ID, "animations/nautilus.animations.json");
	}
}
