...
public class DimetrodonModel extends AnimatedGeoModel<DimetrodonEntity> 
{
	...
	{
		return new ResourceLocation(ModReference.ID, "geo/dimetrodon.geo.json");
	}
	
	@Override
	public ResourceLocation getTextureLocation(DimetrodonEntity object) 
	{
		return new ResourceLocation(ModReference.ID, "textures/model/entity/dimetrodon.png");
	}
	
	@Override
	public ResourceLocation getAnimationFileLocation(DimetrodonEntity animatable) 
	{
		return new ResourceLocation(ModReference.ID, "animations/dimetrodon.animations.json");
	}
