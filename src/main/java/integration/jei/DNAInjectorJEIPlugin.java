...
@JeiPlugin
public class DNAInjectorJEIPlugin implements IModPlugin
{
	private static final ResourceLocation ID = ModUtil.rL("dna_injector_plugin");
	...
	public void registerRecipes(IRecipeRegistration registration) 
	{
		...
		registration.addRecipes(getRecipes(manager, RecipeInit.DNA_INJECTOR_RECIPE), DNAInjectorCategory.ID);
	}
