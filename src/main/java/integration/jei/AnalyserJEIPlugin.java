...
@JeiPlugin
public class AnalyserJEIPlugin implements IModPlugin
{
	private static final ResourceLocation ID = ModUtil.rL("analyser_plugin");
	...
	public void registerRecipes(IRecipeRegistration registration) 
	{
		...
		registration.addRecipes(getRecipes(manager, RecipeInit.ANALYSER_RECIPE), AnalyserCategory.ID);
	}
