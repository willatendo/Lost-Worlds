...
{
	private static final Ingredient FOOD_ITEMS = Ingredient.of(ItemInit.SMALL_PERMIAN_DESERT_PLANT.get(), ItemInit.MEDIUM_PERMIAN_DESERT_PLANT.get(), ItemInit.LARGE_PERMIAN_DESERT_PLANT.get(), ItemInit.GROUND_FERNS.get());
