...
public class ModBreedGoal extends Goal 
{
	...
	public ModBreedGoal(AbstractPrehistoricAnimalEntity entity, double d) 
	{
		this(entity, d, entity.getClass());
	}
	
	public ModBreedGoal(AbstractPrehistoricAnimalEntity entity, double d, Class<? extends AbstractPrehistoricAnimalEntity> entityClass) 
	{
		this.animal = entity;
