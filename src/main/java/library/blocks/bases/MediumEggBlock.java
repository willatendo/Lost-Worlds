...
{
	private static final VoxelShape EGG_ONE = Block.box(3, 0, 4, 7, 8, 8);
	private static final VoxelShape EGG_TWO = Block.box(3, 0, 3, 13, 8, 12);
	private static final VoxelShape EGG_THREE = Block.box(3, 0, 4, 13, 8, 14);
	...
	{
		return state.getValue(EGGS) == 3 ? EGG_THREE : state.getValue(EGGS) == 2 ? EGG_TWO : EGG_ONE;
	}
