...
public class TimeMachineBlock extends ContainerBlock implements ITileEntityProvider	
{
	...
	public void appendHoverText(ItemStack stack, IBlockReader worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn)  
	{
		...
		{
			tooltip.add(ModUtil.cTC("toolTip", "time_machine.holding_shift", TextFormatting.GOLD));
		}
		else
		{
			tooltip.add(ModUtil.cTC("toolTip", "time_machine.not_holding_shift", TextFormatting.GRAY));
		}
	}
